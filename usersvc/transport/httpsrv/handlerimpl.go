...
func (receiver *UsersvcHandlerImpl) SignUp(_writer http.ResponseWriter, _req *http.Request) {
	...
	if _, exists := _req.Form["score"]; exists {
		if casted, _err := cast.ToFloat64E(_req.FormValue("score")); _err != nil {
			http.Error(_writer, _err.Error(), http.StatusBadRequest)
			return
		} else {
			score = casted
...
func (receiver *UsersvcHandlerImpl) GetUser3(_writer http.ResponseWriter, _req *http.Request) {
	...
	if _, exists := _req.Form["attrs"]; exists {
		if casted, _err := cast.ToIntSliceE(_req.Form["attrs"]); _err != nil {
			http.Error(_writer, _err.Error(), http.StatusBadRequest)
			return
		} else {
			attrs = casted
		}
		if _err := rest.ValidateVar(attrs, "", "attrs"); _err != nil {
			http.Error(_writer, _err.Error(), http.StatusBadRequest)
			return
		}
	} else {
	...
	if _, exists := _req.Form["pattrs"]; exists {
		if casted, _err := cast.ToIntSliceE(_req.Form["pattrs"]); _err != nil {
			http.Error(_writer, _err.Error(), http.StatusBadRequest)
			return
		} else {
			pattrs = &casted
		}
		if _err := rest.ValidateVar(pattrs, "", "pattrs"); _err != nil {
			http.Error(_writer, _err.Error(), http.StatusBadRequest)
			return
		}
	} else {
...
func (receiver *UsersvcHandlerImpl) GetUser4(_writer http.ResponseWriter, _req *http.Request) {
	...
	if _, exists := _req.Form["attrs2"]; exists {
		if casted, _err := cast.ToIntSliceE(_req.Form["attrs2"]); _err != nil {
			http.Error(_writer, _err.Error(), http.StatusBadRequest)
			return
		} else {
			attrs2 = &casted
		}
		if _err := rest.ValidateVar(attrs2, "", "attrs2"); _err != nil {
			http.Error(_writer, _err.Error(), http.StatusBadRequest)
			return
		}
	} else {
