...
type ChartReportParagraphStyle struct {
	...
	ForeColor *struct {
	} `json:"foreColor,omitempty" url:"foreColor"`
	// word里面的图表的高，单位厘米
...
type Instance struct {
	ClusterName *string `json:"clusterName,omitempty" url:"clusterName"`

	Enabled *bool `json:"enabled,omitempty" url:"enabled"`

	Ephemeral *bool `json:"ephemeral,omitempty" url:"ephemeral"`

	Healthy *bool `json:"healthy,omitempty" url:"healthy"`

	InstanceHeartBeatInterval *int64 `json:"instanceHeartBeatInterval,omitempty" url:"instanceHeartBeatInterval"`

	InstanceHeartBeatTimeOut *int64 `json:"instanceHeartBeatTimeOut,omitempty" url:"instanceHeartBeatTimeOut"`

	InstanceId *string `json:"instanceId,omitempty" url:"instanceId"`

	InstanceIdGenerator *string `json:"instanceIdGenerator,omitempty" url:"instanceIdGenerator"`

	Ip *string `json:"ip,omitempty" url:"ip"`

	IpDeleteTimeout *int64 `json:"ipDeleteTimeout,omitempty" url:"ipDeleteTimeout"`

	Metadata *struct {
	} `json:"metadata,omitempty" url:"metadata"`

	Port *int `json:"port,omitempty" url:"port"`

	ServiceName *string `json:"serviceName,omitempty" url:"serviceName"`

	Weight *float64 `json:"weight,omitempty" url:"weight"`
}
...
type MergeFieldData struct {
	...
	Values *[]struct {
	} `json:"values,omitempty" url:"values"`
}
